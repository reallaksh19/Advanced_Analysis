...
assertClose(componentContribution(enrichedV2).verticalForceN, 196.2);
assertClose(componentContribution(enrichedCog).verticalForceN, 196.2);
assert.equal(pipeContribution(baseV2).verticalForceN, pipeContribution(enrichedV2).verticalForceN);
assert.equal(pipeContribution(baseCog).verticalForceN, pipeContribution(enrichedCog).verticalForceN);
