...
assert.doesNotMatch(
  ...
  'WP2 Phase 6G qualification must not execute engineering commands.',
);
...
if (workflow !== '') {
  ...
  assert.match(workflow, /lfea-piping-wp2-runtime-bundle-assembler\.mjs/u);
  ...
  assert.doesNotMatch(workflow, /lfea-piping-runtime-bundle-assembler\.mjs/u);
