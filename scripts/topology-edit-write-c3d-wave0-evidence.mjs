...
const OUTPUT = path.join(ROOT, 'reports/qualification/topology-edit-c3d-wave0-evidence.json');
...
const evidenceBase = {
  schema: 'TopologyEditC3DWave0Evidence.v1',
  ...
  qualification: {
    ...
    scope: 'PRESENTATION_AUTHORITY_AND_PRODUCTION_TOOLBAR',
    authorityBoundary: 'DISPLAY_ONLY_NO_CANONICAL_OR_WORKSPACE_MUTATION',
  },
  environment: {
...
const evidence = { ...evidenceBase, evidenceSha256: sha256(canonicalJson(evidenceBase)) };
