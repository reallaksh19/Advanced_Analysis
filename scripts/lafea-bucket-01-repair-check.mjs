...
const checkDefinitions = [
  ...
  { id: 'PROBE_STABLE_POLAR_MESH_DESIGN_V3', script: 'scripts/lafea-bucket-01-probe-stable-mesh-design-check.mjs' },
  { id: 'PROBE_STABLE_CANDIDATE_INTAKE_CONTRACT_V3', script: 'scripts/lafea-bucket-01-probe-stable-candidate-intake-contract-check.mjs' },
  { id: 'PATH_MAPPING_EVIDENCE_COMPATIBILITY', script: 'scripts/lafea-bucket-01-path-mapping-evidence-check.mjs' },
  { id: 'CANDIDATE_PROJECTION_CONTRACT_V3', script: 'scripts/lafea-bucket-01-candidate-projection-contract-check.mjs' },
  ...
  { id: 'CANDIDATE_REPLAY_ADJUDICATION_CONTRACT', script: 'scripts/lafea-bucket-01-candidate-replay-adjudication-check.mjs' },
  { id: 'OSCILLATORY_BOUND_ELIGIBILITY_CONTRACT', script: 'scripts/lafea-bucket-01-oscillatory-bound-eligibility-check.mjs' },
...
const report = {
  schema: 'lafea-bucket-01-repair-check-report/v22',
  ...
  evidenceState: {
    ...
    probeStablePolarMeshDesignV3Verified: repairChecksPass,
    probeStableCandidateIntakeContractV3Verified: repairChecksPass,
    pathMappingEvidenceCompatibilityVerified: repairChecksPass,
    candidateProjectionContractV3Verified: repairChecksPass,
    candidateProjectionExecuted: false,
    controlledCandidateReplayProposalContractVerified: repairChecksPass,
    candidateReplayAdjudicationContractVerified: repairChecksPass,
    oscillatoryBoundEligibilityContractVerified: repairChecksPass,
  ...
  authority: {
    ...
    probeStablePolarMeshDesignV3Implemented: repairChecksPass,
    probeStableCandidateIntakeContractV3Implemented: repairChecksPass,
    pathMappingEvidenceContractImplemented: repairChecksPass,
    candidateProjectionContractV3Implemented: repairChecksPass,
    candidateProjectionExecutionAuthorized: false,
    controlledCandidateReplayProposalContractImplemented: repairChecksPass,
    candidateReplayAdjudicationContractImplemented: repairChecksPass,
    oscillatoryBoundEligibilityContractImplemented: repairChecksPass,
    oscillatoryBoundIsGci: false,
    oscillatoryBoundIndependentAuthorityRequired: true,
