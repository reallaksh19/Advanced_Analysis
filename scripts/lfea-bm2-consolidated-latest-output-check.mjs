...
const report = Object.freeze({
  ...
  closedM031Scope: Object.freeze([
    ...
    'ENERGY_SCALED_RESIDUAL_AND_WEAKEST_NODE_DOF_DIAGNOSTIC',
    'CAESAR_ENDPOINT_LOCAL_FORCE_REPORTING_BASIS',
    'CAESAR_RIGID_10X_ENTERED_WALL_JUNCTION_STUBS',
    'FULL_RETAINED_STATION_ROW_CUSTODY',
  ]),
  nextPriority: Object.freeze([
    'IMPLEMENT_B31J_SKETCH_2_6_WELDOLET_FLEXIBILITY_EQUATIONS',
