 ...
 */
function recoverGaussPointElement(model,element,material,u,dofIndex){
  ...
  const gaussPointResults=element.gaussEvidence.map((gp)=>{
    ...
    const inPlane=matrixVector(element.dMatrix,strain);
