...
export function preflightInputXmlLinearSolve(solvePreparation, options) {
  ...
  return sealInputXmlLinearStiffnessPreflight({
    ...
    preflightId: `IXPF-${semanticHash({
      ...
      solvePreparation: accepted.semanticHash,
    ...
    solvePreparationSemanticHash: accepted.semanticHash,
    solvePreparationEvidenceHash: accepted.evidenceHash,
