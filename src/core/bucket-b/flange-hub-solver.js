...
export const FLANGE_HUB_SOLVER_POLICY = deepFreeze({
  solverPolicyId: 'BKT-B-FLANGE-HUB-DETERMINISTIC-SGS-PCG-V8',
  relativeResidualTolerance: 1e-10,
  internalSolveRelativeResidualTolerance: 1e-11,
...
export function solveFlangeHubLoadCase({ mesh, loadCaseId } = {}) {
  ...
  const internalSolvePolicy = {
    ...FLANGE_HUB_SOLVER_POLICY,
    relativeResidualTolerance:
      FLANGE_HUB_SOLVER_POLICY.internalSolveRelativeResidualTolerance,
  };
  const solution = solveSgsPcg({
    rows: reducedRows,
    rhs,
    diagonal,
    policy: internalSolvePolicy,
