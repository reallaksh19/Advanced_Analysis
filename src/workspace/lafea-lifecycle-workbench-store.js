/**
 * NB-T2 product integration over the retained NB-T1 lifecycle store.
 *
  ...
  function deriveState() {
    const stages = Object.fromEntries(Object.entries(retainedState.stages).map(([stageId, stage]) => [
      ...
      freeze({
        ...
        lifecycleReadiness: projectedReadiness(stageId, stage),
      }),
    ]));
    return freeze({
      ...retainedState,
...
function projectedReadiness(stageId, stage) {
