...
export function ensureTopologyEditTableStyles(documentRef) {
  ...
  style.textContent = `
    ...
    .topology-edit-table input, .topology-edit-table select { min-height:1.8rem; min-width:0; width:100%; box-sizing:border-box; border:1px solid #315070; border-radius:.3rem; background:#07101c; color:#e2e8f0; padding:.25rem .4rem; }
    ...
    @media (max-width: 760px) { .topology-edit-table__header { align-items:stretch; flex-direction:column; } .topology-edit-table__header label { min-width:0; } .topology-edit-table__editor-grid { grid-template-columns:1fr; } .topology-edit-table__editor-grid > button { grid-column:1; } }
  `;
