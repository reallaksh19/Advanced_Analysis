...
export function ensureTopologyEditTableStyles(documentRef) {
  ...
  style.textContent = `
    ...
    @media (max-width: 1100px) { .topology-edit-table__editor-grid { grid-template-columns:1fr 1fr; } }
    @media (max-width: 760px) { .topology-edit-table__header { align-items:stretch; flex-direction:column; } }
  `;
