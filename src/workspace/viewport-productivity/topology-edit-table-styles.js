...
export function ensureTopologyEditTableStyles(documentRef) {
  ...
  style.textContent = `
    ...
    @media (max-width: 760px) { .topology-edit-table__header { align-items:stretch; flex-direction:column; } .topology-edit-table__header label { min-width:0; } .topology-edit-table__editor-grid { grid-template-columns:1fr; } .topology-edit-table__editor-grid .topology-edit-table__wide, .topology-edit-table__editor-grid > button { grid-column:1; } }
  `;
