...
/**
 * Renders the complete Project Data editor for consumers that require the full
 * normalization, editing, WebGL and benchmark profile.
 */
export function renderProjectDataFullView(container, onChanged) {
