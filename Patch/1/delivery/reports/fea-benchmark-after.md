...
Report hash `fnv1a64:e62265d703d9fbf6`
...
| PASS | `THROUGHPUT` | Hash throughput | -257.3464 | -50.00000 | 0 BUDGET | measured 257.3 MB/s over a 4 MB payload; budget is at least 50 MB/s. A BigInt-per-byte implementation measures roughly 15 MB/s. |
...
| PASS | `WALL_CLOCK` | Full pipeline wall clock | 2245.554 | 6000.000 | 0 BUDGET | 196 Q4 elements, 450 DOF. |
...
| PASS | `PREFLIGHT_COST` | Preflight wall clock | 0.1746680 | 50.00000 | 0 BUDGET | Preflight must be cheap enough to run on every package change. |
