...
7. `V-002` — DN25 gate valve
8. `F-002` — DN25 weld-neck flange
9. `O-002` — DN15 side-branch olet
10. `P-012` — DN15 Y branch pipe

The combined branch therefore covers Tee, Pipe, Elbow, Reducer, Valve, Flange, and Olet component families and traverses all three source axes.
...
4. Open **3D Edit**.
5. Inspect the Y-to-Z elbow and riser, the Z-to-X elbow and run, the reducer/valve/flange train, and the DN15 Olet side branch.
